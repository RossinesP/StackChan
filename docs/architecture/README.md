...
LLM/voice pipeline and the swap points relevant to a **Mistral migration**.
...
| [`06-mistral-migration.md`](./06-mistral-migration.md) | **The headline doc**: full-replace vs partial-replace, side by side |
| [`07-path-a-implementation.md`](./07-path-a-implementation.md) | **Path A build guide**: wire protocol, gateway components, milestones |
| [`08-local-dev-setup.md`](./08-local-dev-setup.md) | **Local dev setup**: run the gateway on your laptop, point one StackChan at it, iterate without reflashing |
